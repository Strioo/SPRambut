...
<head>
	...
	<title>Uhair - Selesaikan Masalah Rambut Anda</title>
...
<body>
	...
	<body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="5" class="scrollspy-example without_bg_images">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a href="#" title="Sistem Pakar Forward Chaining" alt="Sistem Pakar Forward Chaining" class="navbar-brand">
						<img alt="Kincai Media" src="../assets/images/uhair.png" height="60px">
					</a>
				</div>
		...
		<!-- Header -->
		<header class="active-navbar appsLand-header cloud-bg" id="kmpanel">
						...
						<div class="row">
							<div class="col-lg-7 col-md-8">
								<div class="site-intro-content">
									<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s"><i class="fa fa-check-circle" style="color:#336699"></i> Diagnosa Kerusakan Rambut</h1>
									<p />
									<h2>Apa itu Uhair?</h2>
									<p />
									<p class="lead wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
										Uhair adalah sebuah website sistem pakar yang didesain khusus untuk membantu pengguna dalam mendiagnosa kerusakan rambut.
									</p>
									<p class="lead wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
										Dengan antarmuka yang ramah pengguna, Uhair tidak hanya memberikan solusi untuk masalah rambut, tetapi juga memberikan edukasi tentang perawatan rambut yang tepat sesuai dengan kondisi unik setiap individu.
									</p>
									<ul class="list-inline list-unstyled header-links">
										<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
											<a href="../index.php" title="Login Akun" alt="Login Akun Sistem Pakar Forward Chaining" class="appsLand-btn appsLand-btn-gradient btn-inverse scrollLink">
		...
		<footer class="apps-footer">
			<div class="footer-bottom">
				<div class="container" style="text-align: center; text-transform: capitalize;">
					<div class="col-md-6">
						Copyright ©2023 <font color="#4D4C7D">uhair corp</font></a>
					</div>
					<div class="col-md-6">
						All rights reserved
					</div>
